...
import com.proveedoresAPI.web.security.CustomAuthFailureHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .csrf().disable()
        .authorizeRequests()
        .antMatchers("/login*", "/login/authenticate","/proveedoresAPI/login*","/proveedoresAPI/login/authenticate", "/tiendaVirtual/**","/producto/porCantidadYFecha").permitAll()
